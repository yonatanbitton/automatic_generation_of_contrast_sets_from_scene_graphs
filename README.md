...
There are 15 files. 12 files for each question template (6 for the original, 6 for the pertubed). Two more files for aggregating all of the question templates (`augmentation_all_original` and `augmentation_all_augmented`). Finally, a statistics file (`stats_first_exp_1_outputs_for_match`). 
